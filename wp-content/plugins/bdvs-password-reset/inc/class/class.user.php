...
class BDPWR_User extends WP_User {
	...
	public function send_reset_code() {
		...
		// Get user's display name (prefer display_name, fall back to user_login)
		$user_name = ! empty( $this->display_name ) ? $this->display_name : $this->user_login;
		...
		return bdpwr_send_password_reset_code_email( $email, $code, $expiration, $user_name );
	}
